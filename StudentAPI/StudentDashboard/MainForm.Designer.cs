...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        // ══════════════════════════════════════════════════════════════════
        // splitMain — HORIZONTAL: top area (list + detail) | bottom create
        // ══════════════════════════════════════════════════════════════════
        splitMain.Dock             = DockStyle.Fill;
        splitMain.Orientation      = Orientation.Horizontal;
        splitMain.FixedPanel       = FixedPanel.Panel2;   // bottom panel fixed
        ...
        // ══════════════════════════════════════════════════════════════════
        // splitTop — VERTICAL inside top: left list | right detail
        // ══════════════════════════════════════════════════════════════════
        ...
        int iy = 38;  // input row y — just below the header
